...
cp "${SCRIPT_DIR}/../../../apps/copaw/fnos/docker/docker-compose.yaml" "${WORK_DIR}/docker/"
...
cp -a "${SCRIPT_DIR}/../../../apps/copaw/fnos/ui" "${WORK_DIR}/ui"

cd "${WORK_DIR}"
tar czf "${SCRIPT_DIR}/../../../app.tgz" docker/ ui/

echo "Built app.tgz for copaw ${VERSION}"
