...
sys.path.insert(0, "/vol1/@apphome/hermes-agent-veenyi/data/venv/lib/python3.11/site-packages")
...
result = asyncio.run(qr_login("/vol1/@apphome/hermes-agent-veenyi/data", timeout_seconds=300))
print("RESULT:", result)
```
...
terminal(
    ...
    "builtins.print = _hooked_print\n"
    "asyncio.run(qr_login('/vol1/@apphome/hermes-agent-veenyi/data', timeout_seconds=300))\n"
    "PYEOF",
    background=True,
